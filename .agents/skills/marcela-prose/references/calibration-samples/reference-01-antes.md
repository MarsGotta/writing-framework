...
Esta referencia compara los parámetros de muestreo y generación entre las tres APIs más usadas del mercado. Está pensada para consulta puntual cuando se está portando código de un proveedor a otro o cuando se está construyendo un cliente que abstrae los tres.
...
Los tres proveedores ofrecen streaming. La activación se hace en parámetro distinto:
...
Cuando se porta código de un proveedor a otro, los puntos de fricción más frecuentes son:
...
Para un cliente abstracto que use los tres, conviene definir una capa interna que normalice estos puntos antes de delegar al SDK específico.
